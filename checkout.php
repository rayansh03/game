...
<!-- BANK AND UPI SECTION START <li><a data-toggle="tab" href="#menu1">BANK</a></li>  -->
<div class="container">
  ...
  <div id="home" class="tab-pane fade in active">
        ...
        <div class="box" style="margin-bottom: 0;">        
            <p>
                ...
                <span class="value">@ybl</span>
                <button class="btn copyBtn" data-clipboard-text="@ybl">Copy</button>
            </p>
